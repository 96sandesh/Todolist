  ...
  return (
    <>
      ...
      <form onSubmit={submitHandler}>
        ...
        <input type='text' className='text-2xl  border-zinc-800 border-4  m-5 px-4 py-2' placeholder='Enter Discription here'
        value={desc}
         onChange={(e)=>{
        ...
        <button className='bg-black text-white text-2xl px-3 p-2 font-bold rounded m-5'>Add Task</button>
      </form>
      <hr />
